...
namespace Transpiler.Analysis
{
                            ...
                            CodePosition Position) : IAzFuncExpn, IAzPattern
    {
        ...
        public static IAzFuncExpn Analyze(Scope scope,
                                          ...
                                          PsArbExpn node)
        {
            var subexpns = node.Children.Select(c => IAzFuncExpn.Analyze(scope, names, c)).ToList();
            ...
            if (subexpns.Count == 1)
            {
                ...
                {
                    symExpn1.Fixity = eFixity.Prefix;
                }
                return subexpns[0];
            }
            ...
            {
                var param = new AzParam(names.Next, IsAutoGenerated: true, op1.Position);
